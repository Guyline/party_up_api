...
CREATE TABLE `copies` (
  `id` uuid NOT NULL,
  `holder_id` uuid DEFAULT NULL,
  `playable_id` uuid DEFAULT NULL,
  ...
  KEY `index_copies_on_playable_id` (`playable_id`),
  KEY `index_copies_on_version_id` (`version_id`),
  KEY `index_copies_on_playable_id_and_holder_id_and_version_id` (`playable_id`,`holder_id`,`version_id`),
  KEY `index_copies_on_playable_id_and_version_id` (`playable_id`,`version_id`),
  KEY `index_copies_on_holder_id_and_version_id` (`holder_id`,`version_id`),
  KEY `index_copies_on_created_at_and_updated_at` (`created_at`,`updated_at`),
  KEY `index_copies_on_updated_at` (`updated_at`),
  KEY `fk_rails_4986047638` (`location_id`),
  ...
  CONSTRAINT `fk_rails_f704870dfb` FOREIGN KEY (`playable_id`) REFERENCES `playables` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ownerships` (
  `id` uuid NOT NULL,
  `copy_id` uuid DEFAULT NULL,
  `owner_id` uuid DEFAULT NULL,
  `created_at` datetime(6) NOT NULL,
  `updated_at` datetime(6) NOT NULL,
  `discarded_at` datetime(6) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `index_ownerships_on_copy_id_and_owner_id` (`copy_id`,`owner_id`),
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `playable_expansions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `playable_expansions` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `playable_id` uuid DEFAULT NULL,
  `expansion_id` uuid DEFAULT NULL,
  `created_at` datetime(6) NOT NULL,
  `updated_at` datetime(6) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `index_playable_expansions_on_playable_id` (`playable_id`),
  KEY `index_playable_expansions_on_expansion_id` (`expansion_id`),
  KEY `index_playable_expansions_on_created_at_and_updated_at` (`created_at`,`updated_at`),
  KEY `index_playable_expansions_on_updated_at` (`updated_at`),
  CONSTRAINT `fk_rails_0dbe4acf3b` FOREIGN KEY (`expansion_id`) REFERENCES `playables` (`id`),
  CONSTRAINT `fk_rails_2472cb67b4` FOREIGN KEY (`playable_id`) REFERENCES `playables` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `playables`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `playables` (
  ...
  `updated_at` datetime(6) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `index_playables_on_bgg_id` (`bgg_id`),
  KEY `index_playables_on_name` (`name`),
  KEY `index_playables_on_created_at_and_updated_at` (`created_at`,`updated_at`),
  KEY `index_playables_on_updated_at` (`updated_at`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `versions` (
  ...
  KEY `index_versions_on_playable_id` (`playable_id`),
  ...
  CONSTRAINT `fk_rails_fa1022dc38` FOREIGN KEY (`playable_id`) REFERENCES `playables` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
